...
HD_PWD='D:/new/Vivado/Vivado/final/record/Record_mode/Record_mode.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Record_mode.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Record_mode.tcl -notrace
