...
HD_PWD='D:/new/Vivado/Vivado/final/record/Record_mode/Record_mode.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Record_mode.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Record_mode.tcl
