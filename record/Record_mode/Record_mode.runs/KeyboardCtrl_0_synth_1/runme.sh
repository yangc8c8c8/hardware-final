...
HD_PWD='D:/new/Vivado/Vivado/final/record/Record_mode/Record_mode.runs/KeyboardCtrl_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log KeyboardCtrl_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source KeyboardCtrl_0.tcl
