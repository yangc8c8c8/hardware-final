...
set rc [catch {
  ...
  set_property ip_repo_paths d:/new/Vivado/Vivado/final/test1/test/test.cache/ip [current_project]
  set_property ip_output_repo d:/new/Vivado/Vivado/final/test1/test/test.cache/ip [current_project]
  add_files -quiet D:/new/Vivado/Vivado/final/test1/test/test.runs/synth_1/test.dcp
