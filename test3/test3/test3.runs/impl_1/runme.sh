...
HD_PWD='D:/new/Vivado/Vivado/final/test3/test3/test3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test.vdi -applog -m64 -messageDb vivado.pb -mode batch -source test.tcl -notrace
