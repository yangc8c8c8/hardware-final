...
set rc [catch {
  ...
  set_property webtalk.parent_dir D:/new/Vivado/Vivado/final/test3/test3/test3.cache/wt [current_project]
  set_property parent.project_path D:/new/Vivado/Vivado/final/test3/test3/test3.xpr [current_project]
  set_property ip_repo_paths d:/new/Vivado/Vivado/final/test3/test3/test3.cache/ip [current_project]
  set_property ip_output_repo d:/new/Vivado/Vivado/final/test3/test3/test3.cache/ip [current_project]
  add_files -quiet D:/new/Vivado/Vivado/final/test3/test3/test3.runs/synth_1/test.dcp
  read_xdc D:/new/Vivado/Vivado/final/test3/test3/test3.srcs/constrs_1/imports/test3/Basys3_Master.xdc
...
set rc [catch {
  ...
  report_power -file test_power_routed.rpt -pb test_power_summary_routed.pb -rpx test_power_routed.rpx
...
set rc [catch {
  ...
  catch { write_sysdef -hwdef test.hwdef -bitfile test.bit -meminfo test.mmi -file test.sysdef }
